...
public class RendererToggler : MonoBehaviour
{
    ...
    public void EnableRenderers()
    {
        ...
        {
            //Debug.Log("Enabling Renderers in " + gameObject.transform.parent.gameObject.name);
    ...
    public void DisableRenderers()
    {
        for (int i = 0; i < renderers.Length; i++)
        {
            //Debug.Log("Disabling Renderers in " + gameObject.transform.parent.gameObject.name);
